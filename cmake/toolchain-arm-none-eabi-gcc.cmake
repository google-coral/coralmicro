...
set(CMAKE_C_FLAGS "-mcpu=cortex-m7 -Wall -mfloat-abi=hard -mfpu=fpv5-d16 -mthumb -fno-common -ffunction-sections -fdata-sections -ffreestanding -fno-builtin -mapcs-frame -std=gnu99 --specs=nano.specs --specs=nosys.specs -DCPU_MIMXRT1176DVMAA_cm7 -g -u _printf_float" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS "-mcpu=cortex-m7 -Wall -mfloat-abi=hard -mfpu=fpv5-d16 -mthumb -fno-common -ffunction-sections -fdata-sections -ffreestanding -fno-builtin -mapcs-frame -fno-rtti -fno-exceptions -std=gnu++11 --specs=nano.specs --specs=nosys.specs -DCPU_MIMXRT1176DVMAA_cm7 -g -u _printf_float" CACHE STRING "" FORCE)
