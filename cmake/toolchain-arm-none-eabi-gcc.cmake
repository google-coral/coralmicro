...
if (NOT DEFINED CORAL_MICRO_BOARD_REVISION)
    set(CORAL_MICRO_BOARD_REVISION P1 CACHE STRING "Board Revision" FORCE)
endif()
...
if (CORAL_MICRO_BOARD_REVISION STREQUAL EVK)
    list(APPEND COMMON_C_FLAGS "-DBOARD_REVISION_EVK")
elseif (CORAL_MICRO_BOARD_REVISION STREQUAL P0)
    list(APPEND COMMON_C_FLAGS "-DBOARD_REVISION_P0")
elseif (CORAL_MICRO_BOARD_REVISION STREQUAL P1)
