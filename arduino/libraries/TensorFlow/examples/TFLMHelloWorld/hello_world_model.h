...
#ifndef CORALMICROPROJECT_HELLO_WORLD_MODEL_H
#define CORALMICROPROJECT_HELLO_WORLD_MODEL_H

// Keep model aligned to 8 bytes to guarantee aligned 64-bit accesses.
alignas(8) inline constexpr unsigned char g_model[] = {
...
inline constexpr int g_model_len = 2488;

#endif  // CORALMICROPROJECT_HELLO_WORLD_MODEL_H
