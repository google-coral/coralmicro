...
#ifndef LIBS_TPU_DARWINN_PORT_DEFAULT_INTEGRAL_TYPES_H_
#define LIBS_TPU_DARWINN_PORT_DEFAULT_INTEGRAL_TYPES_H_
...
#endif  // LIBS_TPU_DARWINN_PORT_DEFAULT_INTEGRAL_TYPES_H_
