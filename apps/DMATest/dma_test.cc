...
uint8_t src_data[BUF_LENGTH] __attribute__((aligned(32)))
__attribute__((section(".sdram_bss,\"aw\",%nobits @")));
uint8_t dst_data[BUF_LENGTH] __attribute__((aligned(32)))
__attribute__((section(".sdram_bss,\"aw\",%nobits @")));
...
extern "C" void app_main(void* param) {
    ...
    DCACHE_InvalidateByRange(reinterpret_cast<uint32_t>(src_data),
                             sizeof(src_data));
    DCACHE_InvalidateByRange(reinterpret_cast<uint32_t>(dst_data),
                             sizeof(dst_data));
    ...
    EDMA_PrepareTransfer(&transfer_config, src_data, sizeof(uint32_t), dst_data,
                         sizeof(uint32_t), sizeof(uint32_t), sizeof(src_data),
