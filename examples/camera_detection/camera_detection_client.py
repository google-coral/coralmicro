...
"""
Displays object detection results received from the camera_detection server
running on a connected Dev Board Micro.

First load camera_detection example onto the Dev Board Micro:

    python3 scripts/flashtool.py -b build -e camera_detection

Then start this client on your computer:

    python3 examples/audio_streaming/camera_detection_client.py
