...
extern "C" void app_main(void* param) {
    ...
    auto message_handler = [](const uint8_t data[coral::micro::ipc::kMessageBufferDataSize], void* param) {
    ...
    coral::micro::IPCM4::GetSingleton()->RegisterAppMessageHandler(message_handler, nullptr);
